...
export function IconAdventure({ size = 24, className }: IconProps) {
  return (
    ...
    >
      ...
      {/* Diamond needle */}
      <path
        d="M28,12 L33,28 L28,44 L23,28 Z"
        stroke="#A33B5E"
        strokeWidth="2"
        strokeLinejoin="round"
      />
...
export function IconMind({ size = 24, className }: IconProps) {
  return (
    ...
    >
      ...
      {/* Filament */}
      <path
        d="M22,34 L22,26 L28,20 L34,26 L34,34"
        stroke="#378ADD"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
